...
# ported to Kindle device by: bosito7 (bosito7@gmail.com)
...
class TextEdit(QtGui.QMainWindow):
    ...
    def maybeSave(self):
        ...
        ret = QtGui.QMessageBox.warning(self, "L:A_N:application_ID:PyQt",
    ...
    def setCurrentFileName(self, fileName=''):
        ...
        self.setWindowTitle("L:A_N:application_ID:PyQt")
    ...
    def fileSaveAs(self):
        fn = QtGui.QFileDialog.getSaveFileName(self, "L:A_N:application_ID:PyQt", None,
    ...
    def about(self):
        QtGui.QMessageBox.about(self, "L:A_N:application_ID:About", 
