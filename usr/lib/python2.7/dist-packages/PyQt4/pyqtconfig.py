...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license --verbose -q /usr/bin/qmake-qt4 -c -j 10 LIBDIR_QT=/usr/lib STRIP= MOC=moc-qt4 LIBS_OPENGL= LIBS_X11= LIBS_THREAD= CFLAGS= CFLAGS_RELEASE= -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  -D_FORTIFY_SOURCE=2 LFLAGS= CXXFLAGS_RELEASE= -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  -D_FORTIFY_SOURCE=2 LFLAGS_RELEASE= -Wl,-z,relro -Wl,-O1 -m /usr/lib/python2.7/config -d /usr/lib/python2.7/dist-packages --dbus /usr/include/dbus-1.0',
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -x PyQt_qreal_double -t Qt_4_8_0 -x Py_v3 -g',
    'pyqt_version':      0x040903,
...
_default_macros = {
    ...
    'CFLAGS_MT_DLL':            '',
    'CFLAGS_MT_DLLDBG':         '',
    'CFLAGS_RELEASE':           ' -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  -D_FORTIFY_SOURCE=2',
    'CFLAGS_RTTI_OFF':          '',
    'CFLAGS_RTTI_ON':           '',
    'CFLAGS_SHLIB':             '-fPIC',
    'CFLAGS_STL_OFF':           '',
    ...
    'CXXFLAGS_MT_DLL':          '',
    'CXXFLAGS_MT_DLLDBG':       '',
    'CXXFLAGS_RELEASE':         ' -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  -D_FORTIFY_SOURCE=2',
    'CXXFLAGS_RTTI_OFF':        '',
    'CXXFLAGS_RTTI_ON':         '',
    'CXXFLAGS_SHLIB':           '-fPIC',
    'CXXFLAGS_STL_OFF':         '',
    ...
    'LFLAGS_RELEASE':           ' -Wl,-z,relro -Wl,-O1',
